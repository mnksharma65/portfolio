                    ...
                    <div class="col-lg-12">
                        <div class="row">
                          <div class="large-12 medium-12 columns">
                            ...
                            echo '<form id="form1" name="form1" method="post" action="service_project.php?name=editProject&&data='.$response.'">';
                                    ?>
                                    ...
                                    <div class="row">
                                            <div class="large-6 columns">
                                              ...
                                              <input type="text" name="projectName" id="projectName" value="<?php echo $project['projectName'];?>" />
                                            </div>
                                            
                                          <div class="large-6 columns">
                                              <label>Project Manager Name</label>
                                              <input type="text" name="pmName" id="pmName" value="<?php echo $project['projectManagerName'];?>" />
                                            </div>
                                      ...
                                      <div class="row">
                                            <div class="large-6 columns">
                                              ...
                                              <input type="number" id="pmMobile" name="pmMobile" value="<?php echo $project['managerMobile'];?>" />
                                            </div>
                                          <div class="large-6 columns">
                                              <label>Manager Email</label>
                                              <input type="email" id="email" name="email" value="<?php echo $project['managerEmail'];?>" />
                                            </div>
                                      </div>
