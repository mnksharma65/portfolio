<?php
    ...
    $page_name="survey.php"; //  If you use this code with a different page ( or file ) name then change this
    $start=$_GET['start'];
    ...
    $nume = $nume_result[0];
    $query_survey = mysql_query("select * from $table limit $eu, $limit");
	  ...
	  <div class="container-fluid">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li><a href="manage_country.php">Country</a></li>
                <li><a href="manage_state.php">State</a></li>
            </ul>
        </div>
        <!-- /#sidebar-wrapper -->
                        ...
                        <div class="row">
                          <div class="large-12 medium-12 columns">
                            <table class="responsive">
                              ...
                              <?php
                                echo '<a href="addSurvey.php" class="tiny button secondary" style="background-color: #81BEF7">Add Survey</a>';
                                if($nume > $limit ){
